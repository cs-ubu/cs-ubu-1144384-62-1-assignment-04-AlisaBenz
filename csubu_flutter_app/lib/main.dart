...
class _AppHomePageState extends State<AppHomePage> {
  ...
  _getStudents() async {
    var url = 'http://cs.sci.ubu.ac.th:7512/topic-1/alisa_60114440396/_search?from=${_page*10}&size=10';
...
//   _getStudents() async {
//     var url = 'http://cs.sci.ubu.ac.th:7512/topic-1/alisa_60114440396/_search?size=${_page*10}&size=10';
//     const headers = { 'Content-Type': 'application/json; charset=utf-8' };
//     const query = { 'query': { 'match_all': {} } };
//     final response = await http.post(url, headers: headers, body: json.encode(query));
//     _students = [];
